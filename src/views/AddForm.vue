            ...
            <section class="row form-section mb-4">
                ...
                <div class="col-12 mb-3">
                    <div class="col-4">
                        ...
                        <select v-model="car.make" class="form-select" :class="{ 'invalid-field': v$.car.make.$error }" required>
                ...
                <div class="col-12 mb-3">
                    <div class="col-4">
                        ...
                        <select class="form-select" v-model="car.year" :class="{ 'invalid-field': v$.car.year.$error }" required>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input class="form-check-input" type="radio" v-model="car.type" value="Hatchback" :class="{ 'invalid-field': v$.car.type.$error }" required>
                    <label class="form-check-label">Hatchback</label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="car.type" value="Sedan" :class="{ 'invalid-field': v$.car.type.$error }" required>
                    <label class="form-check-label">Sedan</label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="car.type" value="SUV" :class="{ 'invalid-field': v$.car.type.$error }" required>
                    <label class="form-check-label">SUV</label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="car.type" value="Convertible" :class="{ 'invalid-field': v$.car.type.$error }" required>
                    <label class="form-check-label">Convertible</label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="car.type" value="Coupe" :class="{ 'invalid-field': v$.car.type.$error }" required>
                ...
                <div class="col-12 mb-3">
                    <div class="col-4">
                        ...
                        <select class="form-select" v-model="car.fuel" :class="{ 'invalid-field': v$.car.fuel.$error }" required>
                ...
                <div class="col-12 mb-3">
                    <div class="col-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter miles per gallon" v-model="car.mpg" :class="{ 'invalid-field': v$.car.mpg.$error }" required>
                    ...
                    <div class="col-12 mb-3">
                        <div class="col-4">
                            <label class="form-label">Door No *</label>
                                <select class="form-select" v-model="car.door" :class="{ 'invalid-field': v$.car.door.$error }" required>
                    ...
                    <div class="col-12 mb-3">
                        <div class="col-4">
                            <label class="form-label">Seat No *</label>
                                <select class="form-select " v-model="car.seat" :class="{ 'invalid-field': v$.car.seat.$error }" required>
                    ...
                    <div class="col-12 mb-3">
                        <div class="col-4">
                            <label class="form-label">Suitcase No *</label>
                                <select class="form-select" v-model="car.suitcase" :class="{ 'invalid-field': v$.car.suitcase.$error }" required>
                            ...
                            <p class="form-text mb-4"><strong>Suitcase No:</strong> Numbers of suitcases fit in a car</p>
                        </div>
                    </div>
            </section>    
            ...
            <section class="row form-section mb-4">
                <h4 class="fw-bold">ADD-ON</h4>
                    <div class="col-12 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="Air-Condition" v-model="car.addon">
                            <label class="check-label">Air Condition</label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Enhance-Cleaning" v-model="car.addon">
                        <label class="check-label">Enhance Cleaning</label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Free-Second-Driver" v-model="car.addon">
                        <label class="check-label">Free Second Driver</label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Unlimited-Mileage" v-model="car.addon">
                    ...
                    <div class="col-12 mb-3">
                        <div class="col-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" min="0.00" step="0.01" placeholder="0.00" v-model="car.price" :class="{ 'invalid-field': v$.car.price.$error }" required>
                    ...
                    <textarea type="text" class="form-control" rows="3" placeholder="Add more description of the car" v-model="car.description"></textarea>
                    </div>
            </section>
...
export default {
    ...
    computed: {
        ...
        if (this.car.make === 'Toyota'){
            options = [{val: '', text: 'Select vehicle model'},
